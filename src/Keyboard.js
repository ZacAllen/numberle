  ...
  const win = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        navigator.clipboard.writeText("Numberle " + guessCount + "/6 " + "\n\n" + emojis + "\nhttps://numberle.netlify.app/");
  ...
  return (
    <div>
      <div className="inputSpacer">
        <p style={{ fontFamily: "var(--mainFont)", color: "#787C7E", textAlign: "center", marginBottom: "20px" }}>
          {`${6 - submissionCount.length + 1} ${6 - submissionCount.length + 1 === 1 ? "try" : "tries"} remaining`}
        </p>
        {data.length === 0 ? (
          <Input
            number={numbers}
      ...
      <Container className="numContainer">
        <Row className="numRow">
          <Col lg={4} xs={4}>
            <Button onClick={(e) => numClick(e)} className="numButton">
              0
            </Button>
          </Col>
          <Col lg={4} xs={4}>
        ...
        <Row className="numRow">
          ...
          <Col lg={4} xs={4}>
            <Button onClick={() => deleteEntry()} className="numButton">
              x
            </Button>
          </Col>
          <Col lg={4} xs={4}>
            <Button onClick={() => submit()} className="numButton">
              ent
            </Button>
          </Col>
        </Row>
